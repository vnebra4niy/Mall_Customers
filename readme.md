...
Open Projekt_UM_L2_48860.ipynb in Jupyter Notebook / JupyterLab or upload to Google Colab.

Upload the Mall_Customers.csv file when prompted.
...
text
Сделай всё в одном формате ГОТОВЫМ для вставки внутрь файла readme через visual studio code
Мы видим, что пользователь хочет получить готовый к вставке файл README.md на английском языке, в одном формате. Нужно просто выдать содержимое README.md без лишних комментариев.
